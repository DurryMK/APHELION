...
globalThis.SolarLanguage = (() => {
  ...
  "Stars and Pulsar can be mined at technology 7. Void can be devoured at technology 10.": "7 级科技可开采各类恒星与脉冲星，10 级科技可吞噬虚空。",
  "Technology 10 can devour it": "10 级科技可吞噬",
  "Devour speed · Harvesting accelerates; carriers and ships change form; ships phase-shift, 30% chance to ignore damage.": "吞噬加速 · 吞噬速率提升；母舰与舰载机换装；舰载机虚化，30% 概率免疫伤害。",
  "Third city ring · Space cities gain a new form; carriers hold one more ship.": "第三城市环 · 太空城换新外观；母舰载机上限 +1。",
  "Void capture · Black holes can be devoured; devourers and ships transcend; ships phase-shift 45% of the time.": "虚空捕获 · 可吞噬黑洞；吞星船与舰载机升华；舰载机 45% 概率虚化免疫。",
  "Orbital": "轨道时代", "Starbound": "星辰时代", "Stellar": "恒星时代", "Starforged": "铸星者", "Ringbuilder": "环世界建造者", "Singular": "奇点",
  "Sweeper": "清道夫", "World Eater": "噬星者", "Glacier Breaker": "碎冰者",
  "Gas Harvester": "采气者", "Sun Eater": "吞日者", "Pulsar Thief": "窃星者", "Voidbringer": "虚空使者",
  ...
  "Stellar mining · Harvest mass from stars and Pulsar. Your ships evolve into black-hulled elites with far greater hull and firepower.": "恒星采集 · 搬运各类恒星与脉冲星的质量。舰载机进化为黑色光效精英舰，血量和火力大幅提升。",
